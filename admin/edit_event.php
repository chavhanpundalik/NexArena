...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($event_name === '') {
        ...
        $error = "Please select registration start date.";

    } elseif ($registration_end === '') {

        $error = "Please select registration end date.";
    ...
    if ($error === "") {
        ...
        if (!$update) {
            ...
            if ($update->execute()) {
                ...
                $error = "Failed to update event: " . $update->error;
            }
...
<head>
    ...
    <title>Edit Event | NexArena</title>

    <link
        rel="stylesheet"
        href="assets/edit_event.css"
    >
...
<main class="container">
    ...
    <div class="page-header">
        ...
        <p>
            Update the details of this NexArena event.
        </p>
