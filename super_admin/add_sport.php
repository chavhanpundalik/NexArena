    ...
    <div class="form-card">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="category" name="category" value="<?= htmlspecialchars($form_data['category']); ?>" placeholder="e.g., Team Sports, Individual, Esports" required>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="selected-icon-preview">
                    ...
                    <div class="icon-info">
                        ...
                        <span class="icon-hint">Click an icon below to select</span>
                    </div>
                ...
                <div class="icon-picker-wrapper">
                    ...
                    <div class="icon-picker" id="iconPicker">
                        ...
                        foreach ($sports_icons as $icon_class => $icon_name): 
                            ...
                            $clean_name = preg_replace('/[🇮🇳⭐🏏🏑🏸🎾🏓⚽🏀🏐⚾🏉🤾♟️🎲🧩⛳🎳🛡️🏃🏊🏋️🤸⚔️🤺🥊🎯🚴🏍️🏎️⛵🚣🐎🐴🏇⛷️🏂⛸️🛷🎿🏄💦🎣💧🥾🚶🚵🏔️🌳⛺♔♕♖♗♘♙🎮💻🔵🔴🎯🪨🪁👑🚩🏆🥇⭐]/u', '', $icon_name);
                        ?>
                            <div class="icon-option <?= $selected; ?>" 
                                 data-icon="<?= $icon_class; ?>" 
                                 data-name="<?= htmlspecialchars(strtolower($clean_name)); ?>"
                                 onclick="selectIcon('<?= $icon_class; ?>', '<?= htmlspecialchars($icon_name); ?>')">
                                <i class="fas <?= $icon_class; ?>"></i>
                                <span class="icon-name"><?= htmlspecialchars($clean_name); ?></span>
                            </div>
                        <?php endforeach; ?>
                    </div>
        ...
        options.forEach(option => {
            ...
            switch(category) {
                case 'all':
                    ...
                    break;
                case 'popular':
                    const popularSports = ['cricket', 'hockey', 'badminton', 'tennis', 'football', 'basketball', 'volleyball', 'kabaddi', 'shooting', 'archery', 'chess'];
                    show = popularSports.some(sport => iconName.includes(sport));
                    break;
                case 'traditional':
                    const traditionalSports = ['chess', 'pachisi', 'snakes', 'ladders', 'gilli', 'danda', 'kho-kho', 'kabaddi', 'lagori', 'pitthu'];
                    show = traditionalSports.some(sport => iconName.includes(sport));
                    break;
                case 'martial':
                    const martialSports = ['kalaripayattu', 'fencing', 'boxing', 'silambam', 'archery', 'shooting', 'malla', 'karate'];
                ...
                case 'water':
                    ...
                    break;
                case 'indoor':
                    const indoorSports = ['chess', 'table tennis', 'badminton', 'squash', 'bowling', 'board games', 'e-sports', 'gamepad'];
                    show = indoorSports.some(sport => iconName.includes(sport));
                    break;
                case 'adventure':
                    const adventureSports = ['hiking', 'trekking', 'mountain', 'camping', 'biking', 'cycling', 'racing', 'skating', 'skiing', 'climbing'];
